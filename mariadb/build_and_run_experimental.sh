...
docker run -d --name task_manager_mariadb -p 3306:3306 --network task_manager_network -e MYSQL_USER=TM -e MYSQL_PASSWORD=0000 -e MYSQL_DATABASE=TM -e MYSQL_ROOT_PASSWORD=0000 task_manager_mariadb
